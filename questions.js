...
},
{
  ...
  {
    id: "lc18-or-6",
    topic: "Lecture 18 - Poverty traps and investment",
    type: "open_response",
    prompt: "<strong>Model A: credit constraints (slide 20).</strong> Two children have different marginal return curves, but they face the same cost of capital. As the country develops, the effective interest rate r falls. Because diminishing returns flatten out at high levels of investment, the gap between the two children moves through three stages: \n&emsp;&emsp;(i) Early, when r is high, both children are pushed to low investment on the steep part of the curve, so the gap is small. \n&emsp;&emsp;(ii) In the middle, both optima sit on the steep portion of the curve where the difference between the two children's marginal returns is large, so the gap is large. \n&emsp;&emsp;(iii) Late, when r is low, both children are pushed onto the flat portion of the curve where their marginal returns nearly converge, so the gap closes. \n\n<strong>Model B: S-shaped technology.</strong> A child's human capital next period is a sex-specific S-shaped function of their human capital this period. Call the threshold beyond which the S-curve takes off the boys' threshold and the girls' threshold, with the girls' threshold higher than the boys' threshold. As development raises the initial endowment of human capital that children start with, the gap between boys and girls moves through three stages: \n&emsp;&emsp;(i) When the initial endowment is below the boys' threshold, both sexes are stuck below their threshold in the low trap, so the gap is small. \n&emsp;&emsp;(ii) When the initial endowment is between the boys' threshold and the girls' threshold, boys cross their threshold and take off while girls do not, so the gap is large. \n&emsp;&emsp;(iii) When the initial endowment is above the girls' threshold, both sexes cross their threshold, so the gap is small again. \n\n<strong>Your task.</strong> \n&emsp;&emsp;1. For each model, name precisely the force that closes the gender gap at high levels of development. \n&emsp;&emsp;2. What kind of empirical variation would let you tell the two models apart? Consider a credit access shock, such as a microfinance rollout or a banking reform, that holds the initial endowment fixed, versus an early endowment shock, such as a famine cohort, a public health rollout, or a prenatal cash transfer, that holds the interest rate fixed. \n&emsp;&emsp;3. Which framework do you find more convincing, or do you think the two are complementary? Argue your position using at least one supporting fact and at least one complicating fact from the lecture.",
    minutes: 10.5
},
    // ============================================
