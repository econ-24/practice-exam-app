...
},
{
  ...
  },
  {
    ...
    type: "open_response",
    prompt: "<strong>Model A: credit constraints (slide 20).</strong> Two children have different marginal return curves, but they face the same cost of capital. As the country develops, the effective interest rate <em>r</em> falls. Because diminishing returns <em>flatten</em> out at high levels of investment, the gap between the two children moves through three stages: \n&emsp;&emsp;(i) Early, when <em>r</em> is high, both children are pushed to low investment on the steep part of the curve, so the gap is small. \n&emsp;&emsp;(ii) In the middle, both optima sit on the steep portion of the curve where the difference between the two children's marginal returns is large, so the gap is large. \n&emsp;&emsp;(iii) Late, when <em>r</em> is low, both children are pushed onto the flat portion of the curve where their marginal returns nearly converge, so the gap closes. \n\n<strong>Model B: S-shaped technology.</strong> Human capital next period, H_{t+1}, is a sex-specific S-shaped function of human capital this period, H_t. Call the threshold beyond which the S-curve takes off H_b* for boys and H_g* for girls, with H_g* greater than H_b*. As development raises the initial endowment H_0 that children start with, the gap between boys and girls moves through three stages: \n&emsp;&emsp;(i) When H_0 is below H_b*, both sexes are stuck below their threshold in the low trap, so the gap is small. \n&emsp;&emsp;(ii) When H_0 is between H_b* and H_g*, boys cross their threshold and take off while girls do not, so the gap is large. \n&emsp;&emsp;(iii) When H_0 is above H_g*, both sexes cross their threshold, so the gap is small again. \n\n<strong>Your task.</strong> \n&emsp;&emsp;1. For each model, name precisely the force that closes the gender gap at high levels of development. \n&emsp;&emsp;2. What kind of empirical variation would let you tell the two models apart? Consider a credit access shock, such as a microfinance rollout or a banking reform, that holds the initial endowment H_0 fixed, versus an early endowment shock, such as a famine cohort, a public health rollout, or a prenatal cash transfer, that holds the interest rate r fixed. \n&emsp;&emsp;3. Which framework do you find more convincing, or do you think the two are complementary? Argue your position using at least one supporting fact and at least one complicating fact from the lecture.",
    minutes: 10.5
}
