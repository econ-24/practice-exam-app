...
},
{
...

  {
    ...
    topic: "Lecture 15 - Why cities grow",
    type: "open_response",
    prompt: "Nigeria's manufacturing squeeze: Between 2023 and 2024, a naira devaluation and the removal of the fuel subsidy drove headline inflation to roughly 31.7 percent and made imported inputs and machinery far more expensive in naira terms. Manufacturing capacity utilization fell to about 56 percent, 767 manufacturing companies shut down in 2023 alone, and multinationals including GlaxoSmithKline and Procter & Gamble ended local production, even as underlying consumer demand for their products in Nigeria remained largely intact. Urban manufacturing is concentrated in Lagos, with a binding urban minimum wage that does not adjust. Using the HT two-sector diagram, predict the impact on \n&emsp;&emsp;a) urban labor demand \n&emsp;&emsp;(b) urban formal employment \n&emsp;&emsp;(c) rural-to-urban migration \n&emsp;&emsp;(d) the urban informal sector. \n&emsp;&emsp;Would your answer to (d) change if Nigeria's informal sector were already at full capacity, unable to absorb any more workers without wages falling? Explain briefly.",
    minutes: 10.5
  },
  ...
  },
{
    ...
    topic: "Lecture 18 - Poverty and gender gaps",
    type: "open_response",
    prompt: "<strong>Model A: credit constraints (slide 20).</strong> Two children with different MR curves; effective r falls with development. With diminishing returns that <em>flatten</em> at high I: \n&emsp;&emsp;• Early (high r): both at low I, gap small. \n&emsp;&emsp;• Middle: optima on the steep portion where MR<sub>b</sub> - MR<sub>g</sub> is large, gap large. \n&emsp;&emsp;• Late (low r): both pushed onto the flat portion, MR<sub>b</sub> ≈ MR<sub>g</sub>, gap closes. \n\n<strong>Model B: S-shaped technology.</strong> H<sub>t+1</sub> = f<sub>i</sub>(H<sub>t</sub>) is S-shaped with sex-specific thresholds H̃<sub>g</sub> > H̃<sub>b</sub>. As initial endowment H<sub>0</sub> rises with development: \n&emsp;&emsp;• H<sub>0</sub> < H̃<sub>b</sub>: both stuck in the low trap, gap small. \n&emsp;&emsp;• H̃<sub>b</sub> < H<sub>0</sub> < H̃<sub>g</sub>: boys cross, girls don't, gap large. \n&emsp;&emsp;• H<sub>0</sub> > H̃<sub>g</sub>: both cross, gap small. \n\n<strong>Your task.</strong> \n&emsp;&emsp;1. For each model, name precisely the force that closes the gap at high development. \n&emsp;&emsp;2. What kind of empirical variation would distinguish the two? Consider credit-access shocks (microfinance, banking reform) holding H<sub>0</sub> fixed, vs. early-endowment shocks (famine cohorts, public-health roll-outs, prenatal CCTs) holding r fixed. \n&emsp;&emsp;3. Which framework do you find more compelling, or are they complementary? Argue your position with at least one supporting fact and at least one complicating fact from the lecture.",
    minutes: 10.5
},
    // ============================================
  ...
  },
  {
    ...
    topic: "Lecture 19 - Adolescence",
    type: "open_response",
    prompt: "Sierra Leone entered this reform with some of the lowest education outcomes in the world, ranked 151st of 157 countries on the Human Capital Index. In 2018, the government began reducing barriers to access to education through government payment for school, admission, and public examination fees, a fall in p, the direct cost of schooling, with the wage a child could earn outside school left unchanged. \n&emsp;&emsp;1. Use the costly schooling model to predict the effect of this fall of schooling costs a child’s time in school and time in work. \n&emsp;&emsp;2. Which households respond most? \n&emsp;&emsp;3. Now suppose a household has two children with different values of b, the return to schooling. The fee elimination lowers p by the same amount for both children. Does the model predict this closes, widens, or leaves untouched the gap in schooling between the two siblings?",
    minutes: 10.5
},
{
    id: "lc19-or-07",
