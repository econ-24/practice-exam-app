...
},
{
  ...
  },
  {
    ...
    topic: "Lecture 18 - Poverty and gender gaps",
    type: "open_response",
    prompt: "<strong>Model A: credit constraints (slide 20).</strong> Two children with different MR curves; effective r falls with development. With diminishing returns that <em>flatten</em> at high I: \n&emsp;&emsp;• Early (high r): both at low I, gap small. \n&emsp;&emsp;• Middle: optima on the steep portion where MR_b - MR_g is large, gap large. \n&emsp;&emsp;• Late (low r): both pushed onto the flat portion, MR_b ≈ MR_g, gap closes. \n\n<strong>Model B: S-shaped technology.</strong> H_{t+1} = f_i(H_t) is S-shaped with sex-specific thresholds H̃_g > H̃_b. As initial endowment H_0 rises with development: \n&emsp;&emsp;• H_0 < H̃_b: both stuck in the low trap, gap small. \n&emsp;&emsp;• H̃_b < H_0 < H̃_g: boys cross, girls don't, gap large. \n&emsp;&emsp;• H_0 > H̃_g: both cross, gap small. \n\n<strong>Your task.</strong> \n&emsp;&emsp;1. For each model, name precisely the force that closes the gap at high development. \n&emsp;&emsp;2. What kind of empirical variation would distinguish the two? Consider credit-access shocks (microfinance, banking reform) holding H_0 fixed, vs. early-endowment shocks (famine cohorts, public-health roll-outs, prenatal CCTs) holding r fixed. \n&emsp;&emsp;3. Which framework do you find more compelling, or are they complementary? Argue your position with at least one supporting fact and at least one complicating fact from the lecture.",
    minutes: 10.5
},
    // ============================================
